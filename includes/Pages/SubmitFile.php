...
$CustomerOrderObj = new SubmitModel();
...
if($_POST){
	...
	echo "</br>" . $total_prod_qty;
	echo "</br>" . $current_date;
	echo "</br>" . $return_status;
	echo "</br>" . $customer_id;
	...
	// for ($x = 0; $x < $count; $x++) {
	//     echo "</br>Order Id : " .$order_id[$x];
	// 	echo "</br>Order Item ID : " .$order_item_id[$x];
	// 	echo "</br>Product Name : " .$product_name[$x];
	// 	echo "</br>Product Image : " .$product_img[$x];		
